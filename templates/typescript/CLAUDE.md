...
- Current version in force: `1.5.1` — check `acknowledgments/claude.ack.json` in ai-rules for updates
...
- Prettier enforced on save via PostToolUse hook (config: `.prettierrc` if present, else defaults)
